...
palabras %>%
  ...
  kable(
    caption = "Cinco palabras asociadas con títulos de mayor puntaje IMDb",
...
palabras %>%
  ...
  kable(
    caption = "Cinco palabras más asociadas con títulos de menor puntaje IMDb",
    col.names = c("Palabra", "Cantidad", "IMDb promedio"),
    booktabs = TRUE,
    align = c("l", "c", "c")
  ) %>%
