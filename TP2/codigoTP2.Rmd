...
En esta sección implementamos diferentes modelo de efectos mixtos. Para este tipo de modelos es muy importante el proceso de diseño, dónde elegiremos que efectos serán fijos y cuáles aleatorios. Para ello vamos a implementar 3 modelos distintos, en el primero solo tomamos como efectos aleatorios al país, en el segundo al director y en el tercero ambos. 

```{r, include = FALSE}
#este bloque y el de abajo son un poco de analisis de datos para saber que efector aleatorios agregar. Despues lo saco
datos_modelado %>%
...
# Ajustamos el modelo de efectos mixtos.
# Consideramos como efecto aleatorio el director.
...
resultados_modelos <- bind_rows(
  resultados_modelos,
  tibble(
    Modelo = "Efectos mixtos (Director)",
    MSE = mse_mixto1
  ),
  tibble(
