...
A continuación, calculamos el estimador Empirical Bayes para la tasa de adopción de cada raza. Dado que se asume una distribución Beta como prior y que el número de adopciones sigue una distribución Binomial, la distribución a posteriori es una Beta. Como estimador utilizamos la esperanza de la distribución a posteriori, dada por:
